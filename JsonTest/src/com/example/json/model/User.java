...
public class User {
	...
	public String toString() {
		return "User [nombre=" + nombre + ", apellido=" + apellido + ", telefono=" + telefono + ", contraseÃ±a=" + contraseña + ", dni=" + dni + ", mail=" + mail + ", sexo=" + sexo + ", fechDeNacimiento=" + fechDeNacimiento + ", address=" + address + "]";
	}
