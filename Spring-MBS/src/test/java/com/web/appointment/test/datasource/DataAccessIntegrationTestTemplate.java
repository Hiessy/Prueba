...
public class DataAccessIntegrationTestTemplate {
	 ...
	 private EmbeddedDatabase db;
	    ...
	    public void testDataAccess() {
	        ...
	        String subCategory = (String) resultSet.get("SUBCATEGORY_NAME"); //subcategory_name tabla subtegory
	        ...
	        String slqGetProvider = "SELECT provider_id, sunday, monday, tuesday, wednesday, thursday, friday, saturday FROM providers where service_id = "+id+" AND personal_state = 'ACTIVE';";
	        ...
	        for(Provider prov : providers){
	        	...
	        	//TODO for horas desde ahora hasta el final del horario de la persona
